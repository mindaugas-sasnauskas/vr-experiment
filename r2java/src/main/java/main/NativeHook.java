 ...
 */
public class NativeHook extends JFrame implements ActionListener, ItemListener, NativeKeyListener, NativeMouseInputListener, NativeMouseWheelListener, WindowListener {
//	cust
	Sockett soc = new Sockett();
	...
	public void nativeKeyPressed(NativeKeyEvent e) {
		displayEventInfo(e);
		try {
			obj.put("nativeKeyPressed", e.getKeyCode());
...
//			obj.put("y", e.getY());
	...
	public void nativeKeyReleased(NativeKeyEvent e) {
		displayEventInfo(e);
		try {
			obj.put("nativeKeyReleased", e.getKeyCode());
//			System.out.println("nativeKeyReleased" + e.getKeyCode());
//			obj.put("y", e.getY());
		} catch (JSONException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		soc.soc("nativeKeyReleased", obj);
	}
	...
	public void nativeKeyTyped(NativeKeyEvent e) {
		displayEventInfo(e);
//		try {
//			obj.put("nativeKeyTyped", e.getKeyCode());
//			System.out.println("nativeKeyTyped" + e.getKeyCode());
////			obj.put("y", e.getY());
//		} catch (JSONException e1) {
//			// TODO Auto-generated catch block
//			e1.printStackTrace();
//		}
//		soc.soc("nativeKeyTyped", obj);
	}
	...
	public void nativeMouseClicked(NativeMouseEvent e) {
		...
		try {
			obj.put("x", e.getX());
			obj.put("y", e.getY());
			obj.put("nativeMouseClicked", e.getButton());
			System.out.println("nativeMouseClicked" + e.getButton());
		} catch (JSONException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		soc.soc("nativeMouseDragged", obj);
	}
	...
	public void nativeMousePressed(NativeMouseEvent e) {
		...
		try {
			obj.put("x", e.getX());
			obj.put("y", e.getY());
			obj.put("nativeMousePressed", e.getButton());
			System.out.println("nativeMousePressed" + e.getButton());
		} catch (JSONException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		soc.soc("nativeMousePressed", obj);
	}
	...
	public void nativeMouseWheelMoved(NativeMouseWheelEvent e) {
		displayEventInfo(e);
		try {
			obj.put("wheel", e.getWheelRotation());
//			obj.put("y", e.getY());
		} catch (JSONException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		soc.soc("nativeMouseWheelMoved", obj);
	}
